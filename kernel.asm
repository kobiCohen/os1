...
80101ea8:	68 ce 79 10 80       	push   $0x801079ce
...
801022f2:	81 fb c8 68 11 80    	cmp    $0x801168c8,%ebx
...
801028e4:	e8 07 1e 00 00       	call   801046f0 <memcmp>
...
80102a14:	e8 37 1d 00 00       	call   80104750 <memmove>
...
80102ac4:	e8 67 19 00 00       	call   80104430 <initlock>
  readsb(dev, &sb);
80102ac9:	58                   	pop    %eax
...
80102bac:	e8 9f 1a 00 00       	call   80104650 <release>
      break;
    }
  }
}
...
80102c0d:	e8 3e 1a 00 00       	call   80104650 <release>
}
...
80102c6c:	e8 df 1a 00 00       	call   80104750 <memmove>
...
80102cd7:	e8 74 19 00 00       	call   80104650 <release>
...
80102d04:	e8 47 19 00 00       	call   80104650 <release>
...
80102dbd:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dbe:	e9 8d 18 00 00       	jmp    80104650 <release>
80102dc3:	90                   	nop
...
80102e22:	e8 49 2c 00 00       	call   80105a70 <idtinit>
...
80102e7c:	68 c8 68 11 80       	push   $0x801168c8
...
80102eae:	e8 0d 08 00 00       	call   801036c0 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 18 2b 00 00       	call   801059d0 <tvinit>
  binit();         // buffer cache
...
80102ed9:	e8 72 18 00 00       	call   80104750 <memmove>
...
80102fae:	e8 3d 17 00 00       	call   801046f0 <memcmp>
...
80103072:	e8 79 16 00 00       	call   801046f0 <memcmp>
...
80103269:	e8 c2 11 00 00       	call   80104430 <initlock>
  (*f0)->type = FD_PIPE;
...
80103343:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103344:	e9 07 13 00 00       	jmp    80104650 <release>
...
80103374:	e8 d7 12 00 00       	call   80104650 <release>
    kfree((char*)p);
...
80103424:	e8 27 12 00 00       	call   80104650 <release>
        return -1;
...
8010347b:	e8 d0 11 00 00       	call   80104650 <release>
  return n;
...
80103509:	e8 42 11 00 00       	call   80104650 <release>
      return -1;
...
80103576:	e8 d5 10 00 00       	call   80104650 <release>
  return i;
...
801035b4:	bb 74 41 11 80       	mov    $0x80114174,%ebx
// If found, change state to EMBRYO and initialize
// state required to run in the kernel.
// Otherwise return 0.
static struct proc*
...
801035b9:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
801035bc:	68 40 41 11 80       	push   $0x80114140
...
801035d3:	81 fb 74 60 11 80    	cmp    $0x80116074,%ebx
...
801035ea:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  ...
  release(&ptable.lock);
801035f1:	68 40 41 11 80       	push   $0x80114140
  release(&ptable.lock);
  return 0;
...
801035fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103602:	e8 49 10 00 00       	call   80104650 <release>
...
80103624:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103627:	c7 40 14 bf 59 10 80 	movl   $0x801059bf,0x14(%eax)
...
80103633:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103636:	e8 65 10 00 00       	call   801046a0 <memset>
...
80103653:	68 40 41 11 80       	push   $0x80114140
80103658:	e8 f3 0f 00 00       	call   80104650 <release>
  return 0;
...
80103673:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103676:	68 40 41 11 80       	push   $0x80114140
8010367b:	e8 d0 0f 00 00       	call   80104650 <release>
...
801036cb:	68 40 41 11 80       	push   $0x80114140
801036d0:	e8 5b 0d 00 00       	call   80104430 <initlock>
}
...
80103784:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103787:	e8 64 0d 00 00       	call   801044f0 <pushcli>
  c = mycpu();
8010378c:	e8 4f ff ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103791:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103797:	e8 44 0e 00 00       	call   801045e0 <popcli>
  return p;
}
...
801037c3:	e8 e8 37 00 00       	call   80106fb0 <setupkvm>
...
801037e1:	e8 da 34 00 00       	call   80106cc0 <inituvm>
  p->sz = PGSIZE;
...
801037f6:	e8 a5 0e 00 00       	call   801046a0 <memset>
...
80103855:	e8 46 10 00 00       	call   801048a0 <safestrcpy>
  p->cwd = namei("/");
...
80103866:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103869:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103870:	e8 bb 0c 00 00       	call   80104530 <acquire>

  p->state = RUNNABLE;
80103875:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)

  release(&ptable.lock);
8010387c:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103883:	e8 c8 0d 00 00       	call   80104650 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801038a8:	e8 43 0c 00 00       	call   801044f0 <pushcli>
  c = mycpu();
801038ad:	e8 2e fe ff ff       	call   801036e0 <mycpu>
  p = c->proc;
801038b2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038b8:	e8 23 0d 00 00       	call   801045e0 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038ce:	e8 2d 35 00 00       	call   80106e00 <allocuvm>
...
801038e0:	e8 cb 32 00 00       	call   80106bb0 <switchuvm>
  return 0;
...
80103904:	e8 f7 35 00 00       	call   80106f00 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103929:	e8 c2 0b 00 00       	call   801044f0 <pushcli>
  c = mycpu();
8010392e:	e8 ad fd ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103933:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103939:	e8 a2 0c 00 00       	call   801045e0 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103958:	e8 23 37 00 00       	call   80107080 <copyuvm>
...
801039d1:	e8 ca 0e 00 00       	call   801048a0 <safestrcpy>

  pid = np->pid;
801039d6:	8b 5f 10             	mov    0x10(%edi),%ebx

  acquire(&ptable.lock);
801039d9:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
801039e0:	e8 4b 0b 00 00       	call   80104530 <acquire>

  np->state = RUNNABLE;
801039e5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)

  release(&ptable.lock);
801039ec:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
801039f3:	e8 58 0c 00 00       	call   80104650 <release>
...
80103a61:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a64:	bb 74 41 11 80       	mov    $0x80114174,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a69:	68 40 41 11 80       	push   $0x80114140
80103a6e:	e8 bd 0a 00 00       	call   80104530 <acquire>
...
80103a83:	81 fb 74 60 11 80    	cmp    $0x80116074,%ebx
...
80103a9b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a9e:	e8 0d 31 00 00       	call   80106bb0 <switchuvm>
      p->state = RUNNING;
...
80103aa9:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103ab0:	e8 46 0e 00 00       	call   801048fb <swtch>
      switchkvm();
80103ab5:	e8 d6 30 00 00       	call   80106b90 <switchkvm>
...
80103aba:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103abd:	81 fb 74 60 11 80    	cmp    $0x80116074,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103ad3:	68 40 41 11 80       	push   $0x80114140
80103ad8:	e8 73 0b 00 00       	call   80104650 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103af5:	e8 f6 09 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103afa:	e8 e1 fb ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103aff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b05:	e8 d6 0a 00 00       	call   801045e0 <popcli>
sched(void)
{
  int intena;
...
80103b0d:	68 40 41 11 80       	push   $0x80114140
80103b12:	e8 99 09 00 00       	call   801044b0 <holding>
...
80103b53:	e8 a3 0d 00 00       	call   801048fb <swtch>
  mycpu()->intena = intena;
...
80103c14:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  ...
  acquire(&ptable.lock);
80103c1b:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103c22:	e8 09 09 00 00       	call   80104530 <acquire>
...
80103c57:	3d 74 60 11 80       	cmp    $0x80116074,%eax
...
80103c64:	ba 74 41 11 80       	mov    $0x80114174,%edx
...
80103c73:	81 fa 74 60 11 80    	cmp    $0x80116074,%edx
...
80103c89:	b8 74 41 11 80       	mov    $0x80114174,%eax
...
80103c93:	3d 74 60 11 80       	cmp    $0x80116074,%eax
...
80103ce7:	68 40 41 11 80       	push   $0x80114140
80103cec:	e8 3f 08 00 00       	call   80104530 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103cf1:	e8 fa 07 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103cf6:	e8 e5 f9 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103cfb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d01:	e8 da 08 00 00       	call   801045e0 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d0d:	e8 de fd ff ff       	call   80103af0 <sched>
  release(&ptable.lock);
80103d12:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103d19:	e8 32 09 00 00       	call   80104650 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d3f:	e8 ac 07 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103d44:	e8 97 f9 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103d49:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d4f:	e8 8c 08 00 00       	call   801045e0 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	81 fe 40 41 11 80    	cmp    $0x80114140,%esi
80103d66:	74 50                	je     80103db8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103d68:	83 ec 0c             	sub    $0xc,%esp
80103d6b:	68 40 41 11 80       	push   $0x80114140
80103d70:	e8 bb 07 00 00       	call   80104530 <acquire>
    release(lk);
80103d75:	89 34 24             	mov    %esi,(%esp)
80103d78:	e8 d3 08 00 00       	call   80104650 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103d93:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103d9a:	e8 b1 08 00 00       	call   80104650 <release>
    acquire(lk);
...
80103dab:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103dac:	e9 7f 07 00 00       	jmp    80104530 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103df5:	e8 f6 06 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103dfa:	e8 e1 f8 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103dff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e05:	e8 d6 07 00 00       	call   801045e0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e0d:	68 40 41 11 80       	push   $0x80114140
80103e12:	e8 19 07 00 00       	call   80104530 <acquire>
...
80103e41:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e46:	81 fb 74 60 11 80    	cmp    $0x80116074,%ebx
...
80103e5e:	68 40 41 11 80       	push   $0x80114140
...
80103e80:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e87:	e8 a4 30 00 00       	call   80106f30 <freevm>
        p->pid = 0;
...
80103ea5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103eac:	c7 04 24 40 41 11 80 	movl   $0x80114140,(%esp)
80103eb3:	e8 98 07 00 00       	call   80104650 <release>
        return pid;
...
80103ec7:	68 40 41 11 80       	push   $0x80114140
80103ecc:	e8 7f 07 00 00       	call   80104650 <release>
      return -1;
...
80103ee7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103eea:	68 40 41 11 80       	push   $0x80114140
80103eef:	e8 3c 06 00 00       	call   80104530 <acquire>
...
80103f1f:	3d 74 60 11 80       	cmp    $0x80116074,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f26:	c7 45 08 40 41 11 80 	movl   $0x80114140,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f31:	e9 1a 07 00 00       	jmp    80104650 <release>
...
80103f47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
80103f4a:	68 40 41 11 80       	push   $0x80114140
80103f4f:	e8 dc 05 00 00       	call   80104530 <acquire>
80103f54:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f57:	b8 74 41 11 80       	mov    $0x80114174,%eax
80103f5c:	eb 0c                	jmp    80103f6a <kill+0x2a>
80103f5e:	66 90                	xchg   %ax,%ax
80103f60:	83 c0 7c             	add    $0x7c,%eax
80103f63:	3d 74 60 11 80       	cmp    $0x80116074,%eax
...
80103f7f:	68 40 41 11 80       	push   $0x80114140
80103f84:	e8 c7 06 00 00       	call   80104650 <release>
      return 0;
...
80103fab:	68 40 41 11 80       	push   $0x80114140
80103fb0:	e8 9b 06 00 00       	call   80104650 <release>
  return -1;
...
80103fd9:	bb e0 41 11 80       	mov    $0x801141e0,%ebx
...
80103feb:	68 e7 7b 10 80       	push   $0x80107be7
...
80103ff8:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ffb:	81 fb e0 60 11 80    	cmp    $0x801160e0,%ebx
...
80104055:	e8 f6 03 00 00       	call   80104450 <getcallerpcs>
...
80104096:	83 ec 10             	sub    $0x10,%esp
  int index = 0;
  int flag = 1;
  for(int i = 0; i < num_of_shortcuts; i++) {
80104099:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
8010409e:	85 c0                	test   %eax,%eax
801040a0:	89 45 e8             	mov    %eax,-0x18(%ebp)
801040a3:	0f 8e 22 01 00 00    	jle    801041cb <remVariable+0x13b>
801040a9:	c7 45 ec 40 2d 11 80 	movl   $0x80112d40,-0x14(%ebp)
801040b0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801040b7:	b9 01 00 00 00       	mov    $0x1,%ecx
801040bc:	31 f6                	xor    %esi,%esi
801040be:	66 90                	xchg   %ax,%ax
801040c0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801040c3:	8b 5d 08             	mov    0x8(%ebp),%ebx
801040c6:	8d 78 20             	lea    0x20(%eax),%edi
801040c9:	eb 30                	jmp    801040fb <remVariable+0x6b>
801040cb:	90                   	nop
801040cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(int k = 0; k < 32; k++)
      if(flag == 0 || (shortcuts[i].var[k] != variable[k] && 
801040d0:	0f b6 13             	movzbl (%ebx),%edx
801040d3:	b9 01 00 00 00       	mov    $0x1,%ecx
801040d8:	38 10                	cmp    %dl,(%eax)
801040da:	74 15                	je     801040f1 <remVariable+0x61>
801040dc:	83 e2 df             	and    $0xffffffdf,%edx
801040df:	83 ea 41             	sub    $0x41,%edx
801040e2:	80 fa 1a             	cmp    $0x1a,%dl
801040e5:	19 c9                	sbb    %ecx,%ecx
801040e7:	83 c1 01             	add    $0x1,%ecx
801040ea:	80 fa 1a             	cmp    $0x1a,%dl
801040ed:	0f 42 75 f0          	cmovb  -0x10(%ebp),%esi
801040f1:	83 c0 01             	add    $0x1,%eax
801040f4:	83 c3 01             	add    $0x1,%ebx
int 
remVariable(char* variable) {
  int index = 0;
  int flag = 1;
  for(int i = 0; i < num_of_shortcuts; i++) {
    for(int k = 0; k < 32; k++)
801040f7:	39 f8                	cmp    %edi,%eax
801040f9:	74 11                	je     8010410c <remVariable+0x7c>
      if(flag == 0 || (shortcuts[i].var[k] != variable[k] && 
801040fb:	85 c9                	test   %ecx,%ecx
801040fd:	75 d1                	jne    801040d0 <remVariable+0x40>
801040ff:	83 c0 01             	add    $0x1,%eax
80104102:	83 c3 01             	add    $0x1,%ebx
80104105:	8b 75 f0             	mov    -0x10(%ebp),%esi
int 
remVariable(char* variable) {
  int index = 0;
  int flag = 1;
  for(int i = 0; i < num_of_shortcuts; i++) {
    for(int k = 0; k < 32; k++)
80104108:	39 f8                	cmp    %edi,%eax
8010410a:	75 ef                	jne    801040fb <remVariable+0x6b>
...
remVariable(char* variable) {
  ...
  int flag = 1;
  for(int i = 0; i < num_of_shortcuts; i++) {
8010410c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104110:	81 45 ec a0 00 00 00 	addl   $0xa0,-0x14(%ebp)
80104117:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010411a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
8010411d:	75 a1                	jne    801040c0 <remVariable+0x30>
  ...
  if(flag == 1) {
8010411f:	83 f9 01             	cmp    $0x1,%ecx
80104122:	0f 85 aa 00 00 00    	jne    801041d2 <remVariable+0x142>
    for(int i = index; i < num_of_shortcuts - 1; i++) {
80104128:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010412b:	83 e8 01             	sub    $0x1,%eax
8010412e:	39 f0                	cmp    %esi,%eax
80104130:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80104133:	0f 8e 80 00 00 00    	jle    801041b9 <remVariable+0x129>
80104139:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010413c:	8d 5e 01             	lea    0x1(%esi),%ebx
8010413f:	8d 0c b6             	lea    (%esi,%esi,4),%ecx
80104142:	69 db 60 ff ff ff    	imul   $0xffffff60,%ebx,%ebx
80104148:	c1 e1 05             	shl    $0x5,%ecx
8010414b:	8d 04 80             	lea    (%eax,%eax,4),%eax
8010414e:	8d b1 00 2e 11 80    	lea    -0x7feed200(%ecx),%esi
80104154:	c1 e0 05             	shl    $0x5,%eax
80104157:	05 60 2d 11 80       	add    $0x80112d60,%eax
8010415c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010415f:	90                   	nop
80104160:	8d be 80 00 00 00    	lea    0x80(%esi),%edi
  }
}
...
80104168:	89 5d f0             	mov    %ebx,-0x10(%ebp)
8010416b:	90                   	nop
...
80104170:	8b 5d f0             	mov    -0x10(%ebp),%ebx
80104173:	8d 14 03             	lea    (%ebx,%eax,1),%edx
80104176:	0f b6 18             	movzbl (%eax),%ebx
80104179:	83 c0 01             	add    $0x1,%eax
  ...
  if(flag == 1) {
    for(int i = index; i < num_of_shortcuts - 1; i++) {
      for(int k = 0; k < 128; k++)
8010417c:	39 f8                	cmp    %edi,%eax
        shortcuts[i].val[k] = shortcuts[i + 1].val[k];
8010417e:	88 1c 0a             	mov    %bl,(%edx,%ecx,1)
        index = i;
      }
  }
  if(flag == 1) {
    for(int i = index; i < num_of_shortcuts - 1; i++) {
      for(int k = 0; k < 128; k++)
80104181:	75 ed                	jne    80104170 <remVariable+0xe0>
80104183:	8b 5d f0             	mov    -0x10(%ebp),%ebx
80104186:	8d 46 e0             	lea    -0x20(%esi),%eax
80104189:	89 df                	mov    %ebx,%edi
8010418b:	90                   	nop
8010418c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        shortcuts[i].val[k] = shortcuts[i + 1].val[k];
      for(int k = 0; k < 32; k++)
        shortcuts[i].var[k] = shortcuts[i + 1].var[k];
80104190:	0f b6 18             	movzbl (%eax),%ebx
80104193:	8d 14 38             	lea    (%eax,%edi,1),%edx
80104196:	83 c0 01             	add    $0x1,%eax
  }
  if(flag == 1) {
    for(int i = index; i < num_of_shortcuts - 1; i++) {
      for(int k = 0; k < 128; k++)
        shortcuts[i].val[k] = shortcuts[i + 1].val[k];
      for(int k = 0; k < 32; k++)
80104199:	39 f0                	cmp    %esi,%eax
        shortcuts[i].var[k] = shortcuts[i + 1].var[k];
8010419b:	88 1c 0a             	mov    %bl,(%edx,%ecx,1)
  }
  if(flag == 1) {
    for(int i = index; i < num_of_shortcuts - 1; i++) {
      for(int k = 0; k < 128; k++)
        shortcuts[i].val[k] = shortcuts[i + 1].val[k];
      for(int k = 0; k < 32; k++)
8010419e:	75 f0                	jne    80104190 <remVariable+0x100>
801041a0:	89 fb                	mov    %edi,%ebx
801041a2:	81 c1 a0 00 00 00    	add    $0xa0,%ecx
801041a8:	81 c6 a0 00 00 00    	add    $0xa0,%esi
801041ae:	81 eb a0 00 00 00    	sub    $0xa0,%ebx
        flag = 0;
        index = i;
      }
  }
  if(flag == 1) {
    for(int i = index; i < num_of_shortcuts - 1; i++) {
801041b4:	3b 75 ec             	cmp    -0x14(%ebp),%esi
801041b7:	75 a7                	jne    80104160 <remVariable+0xd0>
      for(int k = 0; k < 128; k++)
        shortcuts[i].val[k] = shortcuts[i + 1].val[k];
      for(int k = 0; k < 32; k++)
        shortcuts[i].var[k] = shortcuts[i + 1].var[k];
    ...
    num_of_shortcuts -= 1;
801041b9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801041bc:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
    return 0;
  }
  return -1;
}
...
remVariable(char* variable) {
  int index = 0;
801041cb:	31 f6                	xor    %esi,%esi
801041cd:	e9 56 ff ff ff       	jmp    80104128 <remVariable+0x98>
    }
    num_of_shortcuts -= 1;
    return 0;
  }
...
801041e6:	83 ec 0c             	sub    $0xc,%esp
  for(int i = 0; i < num_of_shortcuts; i++) {
801041e9:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
  }
  return -1;
}
...
801041f3:	89 45 e8             	mov    %eax,-0x18(%ebp)
801041f6:	7e 6a                	jle    80104262 <getVariable+0x82>
801041f8:	0f b6 07             	movzbl (%edi),%eax
801041fb:	31 f6                	xor    %esi,%esi
801041fd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104204:	88 45 ee             	mov    %al,-0x12(%ebp)
80104207:	83 e0 df             	and    $0xffffffdf,%eax
8010420a:	83 e8 41             	sub    $0x41,%eax
8010420d:	88 45 ef             	mov    %al,-0x11(%ebp)
    int flag = 1;
    int k = 0;
    while((variable[k] >= 'a' && variable[k] <= 'z') || (variable[k] >= 'A' && variable[k] <= 'Z')) {
80104210:	80 7d ef 19          	cmpb   $0x19,-0x11(%ebp)
80104214:	77 59                	ja     8010426f <getVariable+0x8f>
80104216:	0f b6 4d ee          	movzbl -0x12(%ebp),%ecx
8010421a:	31 c0                	xor    %eax,%eax
8010421c:	bb 01 00 00 00       	mov    $0x1,%ebx
80104221:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(shortcuts[i].var[k] != variable[k])
         flag = 0;
80104228:	38 8c 06 40 2d 11 80 	cmp    %cl,-0x7feed2c0(%esi,%eax,1)
8010422f:	b9 00 00 00 00       	mov    $0x0,%ecx
80104234:	0f 45 d9             	cmovne %ecx,%ebx
      k++;
80104237:	83 c0 01             	add    $0x1,%eax
int
getVariable(char* variable, char* value) {
  for(int i = 0; i < num_of_shortcuts; i++) {
    int flag = 1;
    int k = 0;
    while((variable[k] >= 'a' && variable[k] <= 'z') || (variable[k] >= 'A' && variable[k] <= 'Z')) {
8010423a:	0f b6 0c 07          	movzbl (%edi,%eax,1),%ecx
8010423e:	89 ca                	mov    %ecx,%edx
80104240:	83 e2 df             	and    $0xffffffdf,%edx
80104243:	83 ea 41             	sub    $0x41,%edx
80104246:	80 fa 19             	cmp    $0x19,%dl
80104249:	76 dd                	jbe    80104228 <getVariable+0x48>
      if(shortcuts[i].var[k] != variable[k])
         flag = 0;
      k++;
    }
    if(flag == 1) {
8010424b:	83 fb 01             	cmp    $0x1,%ebx
8010424e:	74 1f                	je     8010426f <getVariable+0x8f>
  return -1;
}
...
getVariable(char* variable, char* value) {
  for(int i = 0; i < num_of_shortcuts; i++) {
80104250:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104254:	81 c6 a0 00 00 00    	add    $0xa0,%esi
8010425a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010425d:	39 45 e8             	cmp    %eax,-0x18(%ebp)
80104260:	75 ae                	jne    80104210 <getVariable+0x30>
...
8010426f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  for(int i = 0; i < num_of_shortcuts; i++) {
    ...
    while((variable[k] >= 'a' && variable[k] <= 'z') || (variable[k] >= 'A' && variable[k] <= 'Z')) {
      if(shortcuts[i].var[k] != variable[k])
         flag = 0;
80104272:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80104275:	8d 0c 80             	lea    (%eax,%eax,4),%ecx
80104278:	31 c0                	xor    %eax,%eax
8010427a:	c1 e1 05             	shl    $0x5,%ecx
8010427d:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if(flag == 1) {
      for(int k = 0; k < 128; k++)
        value[k] = shortcuts[i].val[k];
80104280:	0f b6 94 01 60 2d 11 	movzbl -0x7feed2a0(%ecx,%eax,1),%edx
80104287:	80 
80104288:	88 14 03             	mov    %dl,(%ebx,%eax,1)
      if(shortcuts[i].var[k] != variable[k])
         flag = 0;
      k++;
    }
...
8010428e:	3d 80 00 00 00       	cmp    $0x80,%eax
80104293:	75 eb                	jne    80104280 <getVariable+0xa0>
        value[k] = shortcuts[i].val[k];
      return 0;
    }
  }
...
801042a0 <setVariable>:

int 
setVariable(char* variable, char* value) {
  if(num_of_shortcuts < 31) {
801042a0:	83 3d b8 a5 10 80 1e 	cmpl   $0x1e,0x8010a5b8
  }
  return -1;
}
...
801042aa:	56                   	push   %esi
801042ab:	53                   	push   %ebx
801042ac:	8b 75 0c             	mov    0xc(%ebp),%esi
801042af:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(num_of_shortcuts < 31) {
801042b2:	7f 62                	jg     80104316 <setVariable+0x76>
    if(remVariable(variable) == -1)
801042b4:	53                   	push   %ebx
801042b5:	e8 d6 fd ff ff       	call   80104090 <remVariable>
801042ba:	83 f8 ff             	cmp    $0xffffffff,%eax
      num_of_shortcuts++;
801042bd:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
}
...
setVariable(char* variable, char* value) {
  if(num_of_shortcuts < 31) {
    if(remVariable(variable) == -1)
801042c2:	5a                   	pop    %edx
801042c3:	74 47                	je     8010430c <setVariable+0x6c>
801042c5:	8d 0c 80             	lea    (%eax,%eax,4),%ecx
  }
  return -1;
}
...
801042d0:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
801042d4:	88 94 01 60 2d 11 80 	mov    %dl,-0x7feed2a0(%ecx,%eax,1)
int 
setVariable(char* variable, char* value) {
  if(num_of_shortcuts < 31) {
    if(remVariable(variable) == -1)
...
801042de:	3d 80 00 00 00       	cmp    $0x80,%eax
801042e3:	75 eb                	jne    801042d0 <setVariable+0x30>
801042e5:	31 c0                	xor    %eax,%eax
801042e7:	89 f6                	mov    %esi,%esi
801042e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      shortcuts[num_of_shortcuts].val[k] = value[k];
    for(int k = 0; k < 32; k++)
      shortcuts[num_of_shortcuts].var[k] = variable[k];
801042f0:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
801042f4:	88 94 01 40 2d 11 80 	mov    %dl,-0x7feed2c0(%ecx,%eax,1)
  if(num_of_shortcuts < 31) {
    if(remVariable(variable) == -1)
      num_of_shortcuts++;
    for(int k = 0; k < 128; k++)
      shortcuts[num_of_shortcuts].val[k] = value[k];
    for(int k = 0; k < 32; k++)
801042fb:	83 c0 01             	add    $0x1,%eax
801042fe:	83 f8 20             	cmp    $0x20,%eax
80104301:	75 ed                	jne    801042f0 <setVariable+0x50>
      shortcuts[num_of_shortcuts].var[k] = variable[k];
    return 0;
...
8010430f:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
80104314:	eb af                	jmp    801042c5 <setVariable+0x25>
      shortcuts[num_of_shortcuts].val[k] = value[k];
    for(int k = 0; k < 32; k++)
      shortcuts[num_of_shortcuts].var[k] = variable[k];
    return 0;
...
8010431b:	eb e8                	jmp    80104305 <setVariable+0x65>
...
8010432a:	68 d8 78 10 80       	push   $0x801078d8
...
80104385:	e8 a6 f9 ff ff       	call   80103d30 <sleep>
...
80104393:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104399:	e8 e2 f3 ff ff       	call   80103780 <myproc>
...
801043e4:	e8 f7 fa ff ff       	call   80103ee0 <wakeup>
  release(&lk->lk);
...
801044d3:	e8 08 f2 ff ff       	call   801036e0 <mycpu>
...
801044f9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044fa:	e8 e1 f1 ff ff       	call   801036e0 <mycpu>
...
8010450f:	e8 cc f1 ff ff       	call   801036e0 <mycpu>
80104514:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010451a:	e8 c1 f1 ff ff       	call   801036e0 <mycpu>
...
801045c3:	e8 18 f1 ff ff       	call   801036e0 <mycpu>
...
801045d3:	68 e3 78 10 80       	push   $0x801078e3
...
801045eb:	75 52                	jne    8010463f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
801045ed:	e8 ee f0 ff ff       	call   801036e0 <mycpu>
...
80104605:	e8 d6 f0 ff ff       	call   801036e0 <mycpu>
...
80104619:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104620:	e8 bb f0 ff ff       	call   801036e0 <mycpu>
...
80104635:	68 02 79 10 80       	push   $0x80107902
...
80104642:	68 eb 78 10 80       	push   $0x801078eb
...
80104661:	68 09 79 10 80       	push   $0x80107909
...
80104673:	e8 68 f0 ff ff       	call   801036e0 <mycpu>
...
80104917:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010491a:	e8 61 ee ff ff       	call   80103780 <myproc>
...
801049b5:	e8 c6 ed ff ff       	call   80103780 <myproc>
...
{
  struct proc *curproc = myproc();
801049c6:	e8 b5 ed ff ff       	call   80103780 <myproc>
...
80104a08:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a0b:	e8 70 ed ff ff       	call   80103780 <myproc>
...
80104aa4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104aa5:	e8 d6 ec ff ff       	call   80103780 <myproc>
...
80104aba:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104ae0:	68 11 79 10 80       	push   $0x80107911
...
80104c44:	68 c4 79 10 80       	push   $0x801079c4
...
80104c5c:	68 c3 79 10 80       	push   $0x801079c3
...
80104c71:	68 b7 79 10 80       	push   $0x801079b7
...
80104c7e:	68 c6 79 10 80       	push   $0x801079c6
...
80104c8b:	68 a8 79 10 80       	push   $0x801079a8
...
80104f22:	0f 88 e2 00 00 00    	js     8010500a <sys_link+0x11a>
  ...
  begin_op();
80104f28:	e8 23 dc ff ff       	call   80102b50 <begin_op>
  if((ip = namei(old)) == 0){
...
80104fbb:	e8 e0 c7 ff ff       	call   801017a0 <iput>
  ...
  end_op();
80104fc0:	e8 fb db ff ff       	call   80102bc0 <end_op>
...
80104ffd:	e8 fe c8 ff ff       	call   80101900 <iunlockput>
  end_op();
80105002:	e8 b9 db ff ff       	call   80102bc0 <end_op>
  return -1;
...
80105024:	e8 d7 c8 ff ff       	call   80101900 <iunlockput>
    end_op();
80105029:	e8 92 db ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105036:	eb 92                	jmp    80104fca <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80105038:	e8 83 db ff ff       	call   80102bc0 <end_op>
    return -1;
...
8010506f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80105072:	e8 d9 da ff ff       	call   80102b50 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 c4 79 10 80       	push   $0x801079c4
...
801050b8:	68 c3 79 10 80       	push   $0x801079c3
...
80105157:	e8 a4 c7 ff ff       	call   80101900 <iunlockput>
  ...
  end_op();
8010515c:	e8 5f da ff ff       	call   80102bc0 <end_op>
...
801051b7:	e8 44 c7 ff ff       	call   80101900 <iunlockput>
  end_op();
801051bc:	e8 ff d9 ff ff       	call   80102bc0 <end_op>
  return -1;
...
801051f6:	e9 6b ff ff ff       	jmp    80105166 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
801051fb:	e8 c0 d9 ff ff       	call   80102bc0 <end_op>
    return -1;
...
8010520d:	68 e8 79 10 80       	push   $0x801079e8
...
8010521a:	68 fa 79 10 80       	push   $0x801079fa
...
80105227:	68 d6 79 10 80       	push   $0x801079d6
...
80105272:	0f 88 85 00 00 00    	js     801052fd <sys_open+0xbd>
  ...
  begin_op();
80105278:	e8 d3 d8 ff ff       	call   80102b50 <begin_op>
...
801052f0:	e8 0b c6 ff ff       	call   80101900 <iunlockput>
    end_op();
801052f5:	e8 c6 d8 ff ff       	call   80102bc0 <end_op>
    return -1;
...
8010532b:	75 89                	jne    801052b6 <sys_open+0x76>
      end_op();
8010532d:	e8 8e d8 ff ff       	call   80102bc0 <end_op>
      return -1;
...
801053a3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801053a6:	e8 a5 d7 ff ff       	call   80102b50 <begin_op>
...
801053df:	e8 1c c5 ff ff       	call   80101900 <iunlockput>
  end_op();
801053e4:	e8 d7 d7 ff ff       	call   80102bc0 <end_op>
  return 0;
...
80105403:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105406:	e8 45 d7 ff ff       	call   80102b50 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010546e:	e8 8d c4 ff ff       	call   80101900 <iunlockput>
  end_op();
80105473:	e8 48 d7 ff ff       	call   80102bc0 <end_op>
  return 0;
...
8010549d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010549f:	e8 ac d6 ff ff       	call   80102b50 <begin_op>
...
801054ed:	e8 ae c2 ff ff       	call   801017a0 <iput>
  end_op();
801054f2:	e8 c9 d6 ff ff       	call   80102bc0 <end_op>
  curproc->cwd = ip;
...
80105514:	e8 e7 c3 ff ff       	call   80101900 <iunlockput>
    end_op();
80105519:	e8 a2 d6 ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105529:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
80105530:	e8 8b d6 ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105648:	e8 a3 db ff ff       	call   801031f0 <pipealloc>
...
801056f3:	83 ec 08             	sub    $0x8,%esp
  yield(); 
801056f6:	e8 e5 e5 ff ff       	call   80103ce0 <yield>
  return 0;
}
...
80105713:	83 ec 08             	sub    $0x8,%esp
  exit();
80105716:	e8 95 e4 ff ff       	call   80103bb0 <exit>
...
{
  return wait();
80105724:	e9 c7 e6 ff ff       	jmp    80103df0 <wait>
...
8010574e:	e8 ed e7 ff ff       	call   80103f40 <kill>
...
801057f0:	68 80 60 11 80       	push   $0x80116080
801057f5:	e8 36 ed ff ff       	call   80104530 <acquire>
  ticks0 = ticks;
...
801057fd:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105800:	8b 1d c0 68 11 80    	mov    0x801168c0,%ebx
  while(ticks - ticks0 < n){
...
80105813:	68 80 60 11 80       	push   $0x80116080
80105818:	68 c0 68 11 80       	push   $0x801168c0
8010581d:	e8 0e e5 ff ff       	call   80103d30 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105822:	a1 c0 68 11 80       	mov    0x801168c0,%eax
...
80105840:	68 80 60 11 80       	push   $0x80116080
80105845:	e8 06 ee ff ff       	call   80104650 <release>
      return -1;
...
80105863:	68 80 60 11 80       	push   $0x80116080
80105868:	e8 e3 ed ff ff       	call   80104650 <release>
  return 0;
...
80105884:	83 ec 10             	sub    $0x10,%esp
  uint xticks;
  acquire(&tickslock);
80105887:	68 80 60 11 80       	push   $0x80116080
8010588c:	e8 9f ec ff ff       	call   80104530 <acquire>
  xticks = ticks;
80105891:	8b 1d c0 68 11 80    	mov    0x801168c0,%ebx
  release(&tickslock);
80105897:	c7 04 24 80 60 11 80 	movl   $0x80116080,(%esp)
8010589e:	e8 ad ed ff ff       	call   80104650 <release>
  return xticks;
}
...
801059b6:	54                   	push   %esp
  call trap
801059b7:	e8 e4 00 00 00       	call   80105aa0 <trap>
  addl $4, %esp
...
801059e4:	c6 04 c5 c4 60 11 80 	movb   $0x0,-0x7fee9f3c(,%eax,8)
801059eb:	00 
801059ec:	66 89 0c c5 c2 60 11 	mov    %cx,-0x7fee9f3e(,%eax,8)
801059f3:	80 
801059f4:	c6 04 c5 c5 60 11 80 	movb   $0x8e,-0x7fee9f3b(,%eax,8)
801059fb:	8e 
801059fc:	66 89 14 c5 c0 60 11 	mov    %dx,-0x7fee9f40(,%eax,8)
80105a03:	80 
80105a04:	c1 ea 10             	shr    $0x10,%edx
80105a07:	66 89 14 c5 c6 60 11 	mov    %dx,-0x7fee9f3a(,%eax,8)
80105a0e:	80 
void
tvinit(void)
{
...
80105a2e:	68 80 60 11 80       	push   $0x80116080
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a33:	66 89 15 c2 62 11 80 	mov    %dx,0x801162c2
80105a3a:	c6 05 c4 62 11 80 00 	movb   $0x0,0x801162c4
80105a41:	66 a3 c0 62 11 80    	mov    %ax,0x801162c0
80105a47:	c1 e8 10             	shr    $0x10,%eax
80105a4a:	c6 05 c5 62 11 80 ef 	movb   $0xef,0x801162c5
80105a51:	66 a3 c6 62 11 80    	mov    %ax,0x801162c6

  initlock(&tickslock, "time");
80105a57:	e8 d4 e9 ff ff       	call   80104430 <initlock>
}
...
80105a7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a7f:	b8 c0 60 11 80       	mov    $0x801160c0,%eax
...
80105b32:	e8 49 dc ff ff       	call   80103780 <myproc>
...
80105b40:	e8 3b dc ff ff       	call   80103780 <myproc>
...
80105b55:	e8 26 dc ff ff       	call   80103780 <myproc>
80105b5a:	85 c0                	test   %eax,%eax
80105b5c:	74 0b                	je     80105b69 <trap+0xc9>
80105b5e:	e8 1d dc ff ff       	call   80103780 <myproc>
...
80105b72:	e8 09 dc ff ff       	call   80103780 <myproc>
...
80105bab:	75 a8                	jne    80105b55 <trap+0xb5>
    exit();
80105bad:	e8 fe df ff ff       	call   80103bb0 <exit>
...
80105bbc:	75 ab                	jne    80105b69 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105bbe:	e8 1d e1 ff ff       	call   80103ce0 <yield>
...
80105bc5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105bc8:	e8 93 db ff ff       	call   80103760 <cpuid>
...
80105c07:	e8 54 db ff ff       	call   80103760 <cpuid>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105c40:	e8 3b db ff ff       	call   80103780 <myproc>
80105c45:	8b 58 24             	mov    0x24(%eax),%ebx
80105c48:	85 db                	test   %ebx,%ebx
80105c4a:	75 2c                	jne    80105c78 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105c4c:	e8 2f db ff ff       	call   80103780 <myproc>
80105c51:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105c54:	e8 47 ee ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
80105c59:	e8 22 db ff ff       	call   80103780 <myproc>
...
80105c6f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105c70:	e9 3b df ff ff       	jmp    80103bb0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105c78:	e8 33 df ff ff       	call   80103bb0 <exit>
...
80105c83:	68 80 60 11 80       	push   $0x80116080
80105c88:	e8 a3 e8 ff ff       	call   80104530 <acquire>
      ticks++;
      wakeup(&ticks);
80105c8d:	c7 04 24 c0 68 11 80 	movl   $0x801168c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105c94:	83 05 c0 68 11 80 01 	addl   $0x1,0x801168c0
      wakeup(&ticks);
80105c9b:	e8 40 e2 ff ff       	call   80103ee0 <wakeup>
      release(&tickslock);
80105ca0:	c7 04 24 80 60 11 80 	movl   $0x80116080,(%esp)
...
80105cba:	e8 a1 da ff ff       	call   80103760 <cpuid>
...
80105e67:	6a 00                	push   $0x0
  jmp alltraps
80105e69:	e9 39 fb ff ff       	jmp    801059a7 <alltraps>
...
80105e70:	6a 01                	push   $0x1
  jmp alltraps
80105e72:	e9 30 fb ff ff       	jmp    801059a7 <alltraps>
...
80105e79:	6a 02                	push   $0x2
  jmp alltraps
80105e7b:	e9 27 fb ff ff       	jmp    801059a7 <alltraps>
...
80105e82:	6a 03                	push   $0x3
  jmp alltraps
80105e84:	e9 1e fb ff ff       	jmp    801059a7 <alltraps>
...
80105e8b:	6a 04                	push   $0x4
  jmp alltraps
80105e8d:	e9 15 fb ff ff       	jmp    801059a7 <alltraps>
...
80105e94:	6a 05                	push   $0x5
  jmp alltraps
80105e96:	e9 0c fb ff ff       	jmp    801059a7 <alltraps>
...
80105e9d:	6a 06                	push   $0x6
  jmp alltraps
80105e9f:	e9 03 fb ff ff       	jmp    801059a7 <alltraps>
...
80105ea6:	6a 07                	push   $0x7
  jmp alltraps
80105ea8:	e9 fa fa ff ff       	jmp    801059a7 <alltraps>
...
80105ead:	6a 08                	push   $0x8
  jmp alltraps
80105eaf:	e9 f3 fa ff ff       	jmp    801059a7 <alltraps>
...
80105eb6:	6a 09                	push   $0x9
  jmp alltraps
80105eb8:	e9 ea fa ff ff       	jmp    801059a7 <alltraps>
...
80105ebd:	6a 0a                	push   $0xa
  jmp alltraps
80105ebf:	e9 e3 fa ff ff       	jmp    801059a7 <alltraps>
...
80105ed2:	6a 0d                	push   $0xd
  jmp alltraps
80105ed4:	e9 ce fa ff ff       	jmp    801059a7 <alltraps>
...
80105ed9:	6a 0e                	push   $0xe
  jmp alltraps
80105edb:	e9 c7 fa ff ff       	jmp    801059a7 <alltraps>
...
80105ee2:	6a 0f                	push   $0xf
  jmp alltraps
80105ee4:	e9 be fa ff ff       	jmp    801059a7 <alltraps>
...
80105eeb:	6a 10                	push   $0x10
  jmp alltraps
80105eed:	e9 b5 fa ff ff       	jmp    801059a7 <alltraps>
...
80105ef2:	6a 11                	push   $0x11
  jmp alltraps
80105ef4:	e9 ae fa ff ff       	jmp    801059a7 <alltraps>
...
80105f0d:	6a 14                	push   $0x14
  jmp alltraps
80105f0f:	e9 93 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f16:	6a 15                	push   $0x15
  jmp alltraps
80105f18:	e9 8a fa ff ff       	jmp    801059a7 <alltraps>
...
80105f1f:	6a 16                	push   $0x16
  jmp alltraps
80105f21:	e9 81 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f28:	6a 17                	push   $0x17
  jmp alltraps
80105f2a:	e9 78 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f31:	6a 18                	push   $0x18
  jmp alltraps
80105f33:	e9 6f fa ff ff       	jmp    801059a7 <alltraps>
...
80105f3a:	6a 19                	push   $0x19
  jmp alltraps
80105f3c:	e9 66 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f43:	6a 1a                	push   $0x1a
  jmp alltraps
80105f45:	e9 5d fa ff ff       	jmp    801059a7 <alltraps>
...
80105f4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f4e:	e9 54 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f55:	6a 1c                	push   $0x1c
  jmp alltraps
80105f57:	e9 4b fa ff ff       	jmp    801059a7 <alltraps>
...
80105f5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f60:	e9 42 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f67:	6a 1e                	push   $0x1e
  jmp alltraps
80105f69:	e9 39 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f70:	6a 1f                	push   $0x1f
  jmp alltraps
80105f72:	e9 30 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f79:	6a 20                	push   $0x20
  jmp alltraps
80105f7b:	e9 27 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f82:	6a 21                	push   $0x21
  jmp alltraps
80105f84:	e9 1e fa ff ff       	jmp    801059a7 <alltraps>
...
80105f8b:	6a 22                	push   $0x22
  jmp alltraps
80105f8d:	e9 15 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f94:	6a 23                	push   $0x23
  jmp alltraps
80105f96:	e9 0c fa ff ff       	jmp    801059a7 <alltraps>
...
80105f9d:	6a 24                	push   $0x24
  jmp alltraps
80105f9f:	e9 03 fa ff ff       	jmp    801059a7 <alltraps>
...
80105fa6:	6a 25                	push   $0x25
  jmp alltraps
80105fa8:	e9 fa f9 ff ff       	jmp    801059a7 <alltraps>
...
80105faf:	6a 26                	push   $0x26
  jmp alltraps
80105fb1:	e9 f1 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fb8:	6a 27                	push   $0x27
  jmp alltraps
80105fba:	e9 e8 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fc1:	6a 28                	push   $0x28
  jmp alltraps
80105fc3:	e9 df f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fca:	6a 29                	push   $0x29
  jmp alltraps
80105fcc:	e9 d6 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fd5:	e9 cd f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fdc:	6a 2b                	push   $0x2b
  jmp alltraps
80105fde:	e9 c4 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fe5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fe7:	e9 bb f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fee:	6a 2d                	push   $0x2d
  jmp alltraps
80105ff0:	e9 b2 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105ff7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ff9:	e9 a9 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106000:	6a 2f                	push   $0x2f
  jmp alltraps
80106002:	e9 a0 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106009:	6a 30                	push   $0x30
  jmp alltraps
8010600b:	e9 97 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106012:	6a 31                	push   $0x31
  jmp alltraps
80106014:	e9 8e f9 ff ff       	jmp    801059a7 <alltraps>
...
8010601b:	6a 32                	push   $0x32
  jmp alltraps
8010601d:	e9 85 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106024:	6a 33                	push   $0x33
  jmp alltraps
80106026:	e9 7c f9 ff ff       	jmp    801059a7 <alltraps>
...
8010602d:	6a 34                	push   $0x34
  jmp alltraps
8010602f:	e9 73 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106036:	6a 35                	push   $0x35
  jmp alltraps
80106038:	e9 6a f9 ff ff       	jmp    801059a7 <alltraps>
...
8010603f:	6a 36                	push   $0x36
  jmp alltraps
80106041:	e9 61 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106048:	6a 37                	push   $0x37
  jmp alltraps
8010604a:	e9 58 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106051:	6a 38                	push   $0x38
  jmp alltraps
80106053:	e9 4f f9 ff ff       	jmp    801059a7 <alltraps>
...
8010605a:	6a 39                	push   $0x39
  jmp alltraps
8010605c:	e9 46 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106063:	6a 3a                	push   $0x3a
  jmp alltraps
80106065:	e9 3d f9 ff ff       	jmp    801059a7 <alltraps>
...
8010606c:	6a 3b                	push   $0x3b
  jmp alltraps
8010606e:	e9 34 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106075:	6a 3c                	push   $0x3c
  jmp alltraps
80106077:	e9 2b f9 ff ff       	jmp    801059a7 <alltraps>
...
8010607e:	6a 3d                	push   $0x3d
  jmp alltraps
80106080:	e9 22 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106087:	6a 3e                	push   $0x3e
  jmp alltraps
80106089:	e9 19 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106090:	6a 3f                	push   $0x3f
  jmp alltraps
80106092:	e9 10 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106099:	6a 40                	push   $0x40
  jmp alltraps
8010609b:	e9 07 f9 ff ff       	jmp    801059a7 <alltraps>
...
801060a2:	6a 41                	push   $0x41
  jmp alltraps
801060a4:	e9 fe f8 ff ff       	jmp    801059a7 <alltraps>
...
801060ab:	6a 42                	push   $0x42
  jmp alltraps
801060ad:	e9 f5 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060b4:	6a 43                	push   $0x43
  jmp alltraps
801060b6:	e9 ec f8 ff ff       	jmp    801059a7 <alltraps>
...
801060bd:	6a 44                	push   $0x44
  jmp alltraps
801060bf:	e9 e3 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060c6:	6a 45                	push   $0x45
  jmp alltraps
801060c8:	e9 da f8 ff ff       	jmp    801059a7 <alltraps>
...
801060cf:	6a 46                	push   $0x46
  jmp alltraps
801060d1:	e9 d1 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060d8:	6a 47                	push   $0x47
  jmp alltraps
801060da:	e9 c8 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060e1:	6a 48                	push   $0x48
  jmp alltraps
801060e3:	e9 bf f8 ff ff       	jmp    801059a7 <alltraps>
...
801060ea:	6a 49                	push   $0x49
  jmp alltraps
801060ec:	e9 b6 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060f3:	6a 4a                	push   $0x4a
  jmp alltraps
801060f5:	e9 ad f8 ff ff       	jmp    801059a7 <alltraps>
...
801060fc:	6a 4b                	push   $0x4b
  jmp alltraps
801060fe:	e9 a4 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106105:	6a 4c                	push   $0x4c
  jmp alltraps
80106107:	e9 9b f8 ff ff       	jmp    801059a7 <alltraps>
...
8010610e:	6a 4d                	push   $0x4d
  jmp alltraps
80106110:	e9 92 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106117:	6a 4e                	push   $0x4e
  jmp alltraps
80106119:	e9 89 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106120:	6a 4f                	push   $0x4f
  jmp alltraps
80106122:	e9 80 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106129:	6a 50                	push   $0x50
  jmp alltraps
8010612b:	e9 77 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106132:	6a 51                	push   $0x51
  jmp alltraps
80106134:	e9 6e f8 ff ff       	jmp    801059a7 <alltraps>
...
8010613b:	6a 52                	push   $0x52
  jmp alltraps
8010613d:	e9 65 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106144:	6a 53                	push   $0x53
  jmp alltraps
80106146:	e9 5c f8 ff ff       	jmp    801059a7 <alltraps>
...
8010614d:	6a 54                	push   $0x54
  jmp alltraps
8010614f:	e9 53 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106156:	6a 55                	push   $0x55
  jmp alltraps
80106158:	e9 4a f8 ff ff       	jmp    801059a7 <alltraps>
...
8010615f:	6a 56                	push   $0x56
  jmp alltraps
80106161:	e9 41 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106168:	6a 57                	push   $0x57
  jmp alltraps
8010616a:	e9 38 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106171:	6a 58                	push   $0x58
  jmp alltraps
80106173:	e9 2f f8 ff ff       	jmp    801059a7 <alltraps>
...
8010617a:	6a 59                	push   $0x59
  jmp alltraps
8010617c:	e9 26 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106183:	6a 5a                	push   $0x5a
  jmp alltraps
80106185:	e9 1d f8 ff ff       	jmp    801059a7 <alltraps>
...
8010618c:	6a 5b                	push   $0x5b
  jmp alltraps
8010618e:	e9 14 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106195:	6a 5c                	push   $0x5c
  jmp alltraps
80106197:	e9 0b f8 ff ff       	jmp    801059a7 <alltraps>
...
8010619e:	6a 5d                	push   $0x5d
  jmp alltraps
801061a0:	e9 02 f8 ff ff       	jmp    801059a7 <alltraps>
...
801061a7:	6a 5e                	push   $0x5e
  jmp alltraps
801061a9:	e9 f9 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061b0:	6a 5f                	push   $0x5f
  jmp alltraps
801061b2:	e9 f0 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061b9:	6a 60                	push   $0x60
  jmp alltraps
801061bb:	e9 e7 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061c2:	6a 61                	push   $0x61
  jmp alltraps
801061c4:	e9 de f7 ff ff       	jmp    801059a7 <alltraps>
...
801061cb:	6a 62                	push   $0x62
  jmp alltraps
801061cd:	e9 d5 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061d4:	6a 63                	push   $0x63
  jmp alltraps
801061d6:	e9 cc f7 ff ff       	jmp    801059a7 <alltraps>
...
801061dd:	6a 64                	push   $0x64
  jmp alltraps
801061df:	e9 c3 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061e6:	6a 65                	push   $0x65
  jmp alltraps
801061e8:	e9 ba f7 ff ff       	jmp    801059a7 <alltraps>
...
801061ef:	6a 66                	push   $0x66
  jmp alltraps
801061f1:	e9 b1 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061f8:	6a 67                	push   $0x67
  jmp alltraps
801061fa:	e9 a8 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106201:	6a 68                	push   $0x68
  jmp alltraps
80106203:	e9 9f f7 ff ff       	jmp    801059a7 <alltraps>
...
8010620a:	6a 69                	push   $0x69
  jmp alltraps
8010620c:	e9 96 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106213:	6a 6a                	push   $0x6a
  jmp alltraps
80106215:	e9 8d f7 ff ff       	jmp    801059a7 <alltraps>
...
8010621c:	6a 6b                	push   $0x6b
  jmp alltraps
8010621e:	e9 84 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106225:	6a 6c                	push   $0x6c
  jmp alltraps
80106227:	e9 7b f7 ff ff       	jmp    801059a7 <alltraps>
...
8010622e:	6a 6d                	push   $0x6d
  jmp alltraps
80106230:	e9 72 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106237:	6a 6e                	push   $0x6e
  jmp alltraps
80106239:	e9 69 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106240:	6a 6f                	push   $0x6f
  jmp alltraps
80106242:	e9 60 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106249:	6a 70                	push   $0x70
  jmp alltraps
8010624b:	e9 57 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106252:	6a 71                	push   $0x71
  jmp alltraps
80106254:	e9 4e f7 ff ff       	jmp    801059a7 <alltraps>
...
8010625b:	6a 72                	push   $0x72
  jmp alltraps
8010625d:	e9 45 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106264:	6a 73                	push   $0x73
  jmp alltraps
80106266:	e9 3c f7 ff ff       	jmp    801059a7 <alltraps>
...
8010626d:	6a 74                	push   $0x74
  jmp alltraps
8010626f:	e9 33 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106276:	6a 75                	push   $0x75
  jmp alltraps
80106278:	e9 2a f7 ff ff       	jmp    801059a7 <alltraps>
...
8010627f:	6a 76                	push   $0x76
  jmp alltraps
80106281:	e9 21 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106288:	6a 77                	push   $0x77
  jmp alltraps
8010628a:	e9 18 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106291:	6a 78                	push   $0x78
  jmp alltraps
80106293:	e9 0f f7 ff ff       	jmp    801059a7 <alltraps>
...
8010629a:	6a 79                	push   $0x79
  jmp alltraps
8010629c:	e9 06 f7 ff ff       	jmp    801059a7 <alltraps>
...
801062a3:	6a 7a                	push   $0x7a
  jmp alltraps
801062a5:	e9 fd f6 ff ff       	jmp    801059a7 <alltraps>
...
801062ac:	6a 7b                	push   $0x7b
  jmp alltraps
801062ae:	e9 f4 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062b5:	6a 7c                	push   $0x7c
  jmp alltraps
801062b7:	e9 eb f6 ff ff       	jmp    801059a7 <alltraps>
...
801062be:	6a 7d                	push   $0x7d
  jmp alltraps
801062c0:	e9 e2 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062c7:	6a 7e                	push   $0x7e
  jmp alltraps
801062c9:	e9 d9 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062d0:	6a 7f                	push   $0x7f
  jmp alltraps
801062d2:	e9 d0 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062ea:	e9 b8 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801062f6:	e9 ac f6 ff ff       	jmp    801059a7 <alltraps>
...
80106a93:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106a96:	e8 c5 cc ff ff       	call   80103760 <cpuid>
...
80106aa8:	66 89 90 18 28 11 80 	mov    %dx,-0x7feed7e8(%eax)
80106aaf:	66 89 88 1a 28 11 80 	mov    %cx,-0x7feed7e6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ab6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106abb:	31 c9                	xor    %ecx,%ecx
80106abd:	66 89 90 20 28 11 80 	mov    %dx,-0x7feed7e0(%eax)
...
80106ac4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ac9:	66 89 88 22 28 11 80 	mov    %cx,-0x7feed7de(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ad0:	31 c9                	xor    %ecx,%ecx
80106ad2:	66 89 90 28 28 11 80 	mov    %dx,-0x7feed7d8(%eax)
80106ad9:	66 89 88 2a 28 11 80 	mov    %cx,-0x7feed7d6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ae0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106ae5:	31 c9                	xor    %ecx,%ecx
80106ae7:	66 89 90 30 28 11 80 	mov    %dx,-0x7feed7d0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106aee:	c6 80 1c 28 11 80 00 	movb   $0x0,-0x7feed7e4(%eax)
static inline void
...
80106afa:	c6 80 1d 28 11 80 9a 	movb   $0x9a,-0x7feed7e3(%eax)
80106b01:	c6 80 1e 28 11 80 cf 	movb   $0xcf,-0x7feed7e2(%eax)
80106b08:	c6 80 1f 28 11 80 00 	movb   $0x0,-0x7feed7e1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b0f:	c6 80 24 28 11 80 00 	movb   $0x0,-0x7feed7dc(%eax)
80106b16:	c6 80 25 28 11 80 92 	movb   $0x92,-0x7feed7db(%eax)
80106b1d:	c6 80 26 28 11 80 cf 	movb   $0xcf,-0x7feed7da(%eax)
80106b24:	c6 80 27 28 11 80 00 	movb   $0x0,-0x7feed7d9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b2b:	c6 80 2c 28 11 80 00 	movb   $0x0,-0x7feed7d4(%eax)
80106b32:	c6 80 2d 28 11 80 fa 	movb   $0xfa,-0x7feed7d3(%eax)
80106b39:	c6 80 2e 28 11 80 cf 	movb   $0xcf,-0x7feed7d2(%eax)
80106b40:	c6 80 2f 28 11 80 00 	movb   $0x0,-0x7feed7d1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b47:	66 89 88 32 28 11 80 	mov    %cx,-0x7feed7ce(%eax)
80106b4e:	c6 80 34 28 11 80 00 	movb   $0x0,-0x7feed7cc(%eax)
80106b55:	c6 80 35 28 11 80 f2 	movb   $0xf2,-0x7feed7cb(%eax)
80106b5c:	c6 80 36 28 11 80 cf 	movb   $0xcf,-0x7feed7ca(%eax)
80106b63:	c6 80 37 28 11 80 00 	movb   $0x0,-0x7feed7c9(%eax)
...
80106b90:	a1 c4 68 11 80       	mov    0x801168c4,%eax
...
80106bdf:	e8 fc ca ff ff       	call   801036e0 <mycpu>
80106be4:	89 c3                	mov    %eax,%ebx
80106be6:	e8 f5 ca ff ff       	call   801036e0 <mycpu>
80106beb:	89 c7                	mov    %eax,%edi
80106bed:	e8 ee ca ff ff       	call   801036e0 <mycpu>
80106bf2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bf5:	83 c7 08             	add    $0x8,%edi
80106bf8:	e8 e3 ca ff ff       	call   801036e0 <mycpu>
...
80106c39:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106c3e:	e8 9d ca ff ff       	call   801036e0 <mycpu>
80106c43:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c4a:	e8 91 ca ff ff       	call   801036e0 <mycpu>
80106c4f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106c54:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106c58:	e8 83 ca ff ff       	call   801036e0 <mycpu>
...
80106c66:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c69:	e8 72 ca ff ff       	call   801036e0 <mycpu>
...
80106c8b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106c8c:	e9 4f d9 ff ff       	jmp    801045e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106cef:	e8 ac d9 ff ff       	call   801046a0 <memset>
...
80106d20:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106d21:	e9 2a da ff ff       	jmp    80104750 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106e43:	e8 58 d8 ff ff       	call   801046a0 <memset>
...
80106fd0:	e8 cb d6 ff ff       	call   801046a0 <memset>
...
8010703b:	a3 c4 68 11 80       	mov    %eax,0x801168c4
...
801070c0:	e8 8b d6 ff ff       	call   80104750 <memmove>
...
801071ef:	e8 5c d5 ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
